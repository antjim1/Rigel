...
public class StarTest2 {
    ...
    private static Star newStarWithColorIndex(float colorIndex) {
        ...
        return new Star(1, Translation.constant("Rigel"), eqPos, 0, colorIndex);
    }

    @Test
    void constructorFailsWhenHipparcosNumberIsNegative() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Star(-1, Translation.constant("Rigel"), EquatorialCoordinates.of(0, 0), 0, 0);
        });
    }
    ...
    void constructorFailsWhenEquatorialPosIsNull() {
        assertThrows(NullPointerException.class, () -> {
            new Star(1, Translation.constant("Rigel"), null, 0, 0);
        });
    }
    ...
    void constructorFailsWhenColorIndexIsOutOfBounds() {
        EquatorialCoordinates eqPos = EquatorialCoordinates.of(0, 0);
        assertThrows(IllegalArgumentException.class, () -> {
            new Star(1, Translation.constant("Rigel"), eqPos, 0, -0.6f);
        });
        assertThrows(IllegalArgumentException.class, () -> {
            new Star(1, Translation.constant("Rigel"), eqPos, 0, +5.6f);
        });
    }
    ...
    void starNameIsCorrect() {
        ...
        for (int i = 0; i < TestRandomizer.RANDOM_ITERATIONS; i++) {
            ...
            var s = new Star(1, Translation.constant(name), EquatorialCoordinates.of(0, 0), 0, 0);
    ...
    void starAngularSizeIs0() {
        var s = new Star(1, Translation.constant("Rigel"), EquatorialCoordinates.of(1, 1), 2, 3);
    ...
    void starMagnitudeIsCorrect() {
        ...
        for (int i = 0; i < TestRandomizer.RANDOM_ITERATIONS; i++) {
            ...
            var s = new Star(1, Translation.constant("Rigel"), eqPos, m, 0);
    ...
    void starEquatorialPosIsCorrect() {
        ...
        for (int i = 0; i < TestRandomizer.RANDOM_ITERATIONS; i++) {
            ...
            var s = new Star(1, Translation.constant("Rigel"), eqPos, 0, 0);
    ...
    void starInfoIsCorrect() {
        ...
        for (int i = 0; i < TestRandomizer.RANDOM_ITERATIONS; i++) {
            ...
            //            var s = new Planet(starName, equ, 0, 0);  // FIXME Correct test
    ...
    void starHipparcosIdIsCorrect() {
        for (int hip = 0; hip < 10; hip++) {
            EquatorialCoordinates eqPos = EquatorialCoordinates.of(0, 0);
            var s = new Star(hip, Translation.constant("Rigel"), eqPos, 0, 0);
