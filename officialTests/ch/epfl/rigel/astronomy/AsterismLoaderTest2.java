...
public class AsterismLoaderTest2 {
    ...
    void loaderWorks() throws IOException {
        var stars = List.of(
                new Star(35904, Translation.constant("Aludra"), EquatorialCoordinates.of(1.9377301884962992, -0.5114356374748288), 2.450f, -0.083f),
                new Star(35205, Translation.constant("XXX"), EquatorialCoordinates.of(1.9049537265834606, -0.48661836778492), 4.660f, 1.589f),
                new Star(34444, Translation.constant("Wezen"), EquatorialCoordinates.of(1.869210132341708, -0.46064823373741876), 1.830f, 0.671f),
                new Star(33579, Translation.constant("Adhara"), EquatorialCoordinates.of(1.8265996485677483, -0.5056582518554612), 1.500f, -0.211f),
                new Star(33977, Translation.constant("YYY"), EquatorialCoordinates.of(1.8457927748229326, -0.41596939743728123), 3.020f, -0.077f),
                new Star(32349, Translation.constant("Sirius"), EquatorialCoordinates.of(1.7677953696021995, -0.291751258517685), -1.44f, 0.009f),
                new Star(30324, Translation.constant("Mirzam"), EquatorialCoordinates.of(1.6698426956468702, -0.31338988393796), 1.980f, -0.240f),
                new Star(37279, Translation.constant("Procyon"), EquatorialCoordinates.of(2.004083041242831, 0.09119333187796), 0.400f, 0.432f),
                new Star(36188, Translation.constant("Gomeisa"), EquatorialCoordinates.of(1.9510630590622124, 0.144675846904975), 2.890f, -0.097f));
