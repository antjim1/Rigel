...
public class MoonTest2 {
    ...
    void moonConstructorFailsWhenPhaseIsInvalid() {
        assertThrows(IllegalArgumentException.class, () -> {
            var equ = EquatorialCoordinates.of(0, 0);
            new Moon(equ, 0f, -0.00001f);
        });
        assertThrows(IllegalArgumentException.class, () -> {
            var equ = EquatorialCoordinates.of(0, 0);
            new Moon(equ, 0f, +1.00001f);
        });
    }
    ...
    void moonAngularSizeIsCorrect() {
        ...
        for (int i = 0; i < TestRandomizer.RANDOM_ITERATIONS; i++) {
            ...
            var m = new Moon(equ, angularSize, 0);
    ...
    void moonInfoIncludesPhase() {
        var equ = EquatorialCoordinates.of(0, 0);
        var m1 = new Moon(equ, 0, 0.1f);
        var m2 = new Moon(equ, 0, 0.9f);
